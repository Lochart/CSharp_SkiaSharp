...
/*
 * Ссылка https://www.c-sharpcorner.com/article/getting-started-with-skiasharp-with-xamarin-forms/
 */
namespace CSharp_SkiaSharp
{
    public class Draw_Rectangle_Number : ContentPage
    {
        private SKCanvasView skiaView;

        public Draw_Rectangle_Number()
        {
